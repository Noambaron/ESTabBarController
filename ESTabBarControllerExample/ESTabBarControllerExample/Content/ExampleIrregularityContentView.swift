...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    private func playMaskAnimation(animateView view: UIView, target: UIView, completion: (() -> ())?) {
        ...
        scale?.duration = 0.3
        scale?.timingFunction = CAMediaTimingFunction.init(name: kCAMediaTimingFunctionEaseOut)  //CAMediaTimingFunctionName.easeOut)
        ...
        alpha?.duration = 0.25
        alpha?.timingFunction = CAMediaTimingFunction.init(name: kCAMediaTimingFunctionEaseOut)  //CAMediaTimingFunctionName.easeOut)
